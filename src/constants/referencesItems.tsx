...
const referencesItems = [
    { photo: References1, alt: 'List referencyjny od firmy X' },
    { photo: References2, alt: 'List referencyjny od firmy Y' },
    { photo: References3, alt: 'List referencyjny od firmy Z' },
]
